 ...
 *   https://datatables.net/download/#dt/dt-1.10.22/fh-3.1.7/sp-1.2.0
 *
 * Included libraries:
 *   DataTables 1.10.22, FixedHeader 3.1.7, SearchPanes 1.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.22/fh-3.1.7/sp-1.2.0",
